...
export const registerSchema = z.object({
  ...
  email: z.string()
    ...
    .toLowerCase()
    .trim(),
  password: z.string().min(8).max(128).regex(/[A-Z]/, 'Debe contener al menos una mayúscula').regex(/[a-z]/, 'Debe contener al menos una minúscula').regex(/[0-9]/, 'Debe contener al menos un número'),
  ...
  encryptedPrivateKeyRecovery: z.string().min(1),
  recoveryKeySalt: z.string().optional(),
});

/**
 * Schema para crear usuario administrador (por otro admin)
 */
