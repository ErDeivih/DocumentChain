...
/** Direcci+好 por defecto del contrato `DocumentRegistry` en red local. */
const DEFAULT_LOCAL_DOCUMENT_REGISTRY_ADDRESS = '0x5FbDB2315678afecb367f032d93F642f64180aa3';

/**
 * Determina si un valor es una direcci+好 Ethereum v+璱ida.
 *
 * @param value - Valor a evaluar.
 * @returns `true` si el valor es una cadena con formato de direcci+好 Ethereum.
 */
 ...
 *
 * @returns Objeto con las variables de entorno le+︸as del archivo.
 */
...
/**
 * Obtiene la direcci+好 del contrato `DocumentRegistry` desde el archivo de despliegue.
 *
 * @returns Direcci+好 Ethereum v+璱ida, o `null` si no se encuentra o no es v+璱ida.
 */
...
/**
 * Resuelve la direcci+好 del contrato `DocumentRegistry` priorizando
 * la direcci+好 de despliegue local cuando se usa un RPC local.
 *
 * @returns Direcci+好 del contrato resuelta, o `undefined` si no se puede determinar.
 */
...
/**
 * Resuelve la direcci+好 del contrato `DocumentRegistry`, utilizando una direcci+好
 * por defecto local como +奸timo recurso.
 *
 * @returns Direcci+好 del contrato garantizada.
 */
