...
El diagrama E-R muestra las relaciones entre las 16 tablas de la base de datos PostgreSQL. Las entidades principales son: \texttt{users}, \texttt{documents} y \texttt{wallets}; las entidades de relación incluyen \texttt{versions}, \texttt{document\_signatures}, \texttt{folders} y \texttt{events}; las entidades de soporte son \texttt{sessions}, \texttt{notifications}, \texttt{user\_stats}, \texttt{document\_stats}, \texttt{system\_stats}, \texttt{notification\_preferences}, \texttt{email\_verifications}, \texttt{password\_resets} y \texttt{system\_config}.
