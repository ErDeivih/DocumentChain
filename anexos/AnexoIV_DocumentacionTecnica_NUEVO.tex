...
ethers & v6 & Lectura de eventos on-chain, preparacion de transacciones y verificacion de firmas EIP-712. \\
\bottomrule
\end{tabular}
...
\textbf{Event Listener.} Al iniciarse, el backend suscribe una instancia del contrato a los eventos \texttt{DocumentCreated}, \texttt{VersionCreated}, \texttt{DocumentSigned} y \texttt{PermissionChanged}. Cuando se emite un evento, el callback actualiza el estado correspondiente en PostgreSQL y emite un mensaje WebSocket a los clientes conectados.
