...
El catalogo funcional del proyecto se ha fijado en \textbf{43 casos de uso principales} (Tabla~\ref{tab:consolidacion-uc}). Durante el desarrollo se observo que muchas operaciones eran realmente pasos de otras mas grandes, asi que en vez de mantenerlas como casos de uso independientes se decidio agruparlas dentro de las que ya habia. La funcionalidad no se ha perdido: simplemente se ha reorganizado para que el catalogo sea mas manejable.
...
\begin{table}[H]
    ...
    \hline
    \end{tabular}
    \caption{Consolidación del catálogo funcional en 43 casos de uso principales}
...
\ucsubsubsection{UC-0014: Reenviar Verificaci\'{o}n de Email}
...
\hline
\end{tabular}
\caption{Especificacion del caso de uso UC-0014}
\end{table}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\textwidth]{diagramas/seq-bce-uc0014-resend-verification.png}
    \caption{Diagrama de secuencia de analisis BCE -- UC-0012: Reenviar Verificacion de Email}
    \label{fig:seq-bce-uc0014-resend}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.92\textwidth]{diagramas/seq-resend-verification.png}
    \caption{Diagrama de secuencia de diseno -- UC-0014: Reenviar Verificacion de Email}
    \label{fig:seq-uc0014-resend}
\end{figure}

\ucsubsubsection{UC-0015: Subir Documento}

\begin{longtable}{|p{4cm}|p{10cm}|}
\hline
\textbf{UC-0015} & Subir Documento \\
\hline
\textbf{Versión} & 1.0 \\
\hline
\textbf{Autores} & David Pérez Velasco \\
...
\hline
UC-0009 Eliminar Cuenta & seq-bce-uc0010-delete-account.png & seq-bce-uc0010-delete-account.png \\
\hline
UC-0010 Cambiar Contrasena & seq-bce-uc0011-change-password.png & seq-change-password.png \\
\hline
UC-0011 Verificar Email & seq-bce-uc0013-verify-email.png & seq-verify-email.png \\
\hline
UC-0012 Reenviar Verificacion de Email & seq-bce-uc0014-resend-verification.png & seq-resend-verification.png \\
\hline
...
\hline
UC-0034 Ver Estadisticas Personales & seq-bce-uc0038-stats.png & seq-user-stats.png \\
\hline
UC-0035 Ver Estadisticas Globales & seq-bce-uc0039-global-stats.png & seq-global-stats.png \\
\hline
...
\noindent La tabla anterior muestra la cobertura completa de los requisitos de informacion por parte de los 43 casos de uso. Todos los IRQ estan cubiertos por al menos un caso de uso, y cada caso de uso cuenta con diagramas de secuencia de analisis (BCE) y diseno documentados en el Anexo III.
