...
\begin{table}[H]
    ...
    \hline
    \textbf{Descripción} & El sistema debe soportar el ciclo de vida completo del documento digital: alta, versionado, archivado lógico, restauración de versiones anteriores y organización mediante carpetas y categorías. Cada operación relevante debe quedar registrada en el historial de actividad asociado al documento. \\
    \hline
    \textbf{Importancia} & Alta \\
    \hline
    \textbf{Urgencia} & Alta \\
...
\begin{table}[H]
    ...
    \hline
    Gestión documental & Alta, descarga y organización & Subida de documentos, clasificación por carpetas y categorías, listados y búsquedas. \\
    \hline
...
\begin{table}[H]
    ...
    \hline
    RF-02 & Gestión documental & Alta de documentos, organización por carpetas o categorías, consulta, descarga y archivado lógico. \\
    \hline
...
\begin{table}[H]
    ...
    \hline
    Persistencia relacional & PostgreSQL & Usuarios, sesiones, carpetas, categorías, notificaciones, sincronización y proyecciones de consulta. \\
    \hline
...
El listado principal de documentos ofrece filtrado por categoría, carpeta, estado y búsqueda textual. La Figura~\ref{fig:docs-page-mem} muestra el estado del panel documental con varios documentos.
...
\begin{table}[H]
    ...
    \hline
    PostgreSQL & Usuarios, sesiones, preferencias, estados de sincronización, carpetas, categorías, notificaciones y proyecciones de consulta & Permite modelado rico, búsquedas, filtros y actualización frecuente con bajo coste operativo. \\
    \hline
