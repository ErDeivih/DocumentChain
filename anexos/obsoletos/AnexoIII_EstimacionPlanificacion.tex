...
La complejidad particular de este proyecto reside en la integración de cuatro subsistemas heterogéneos: un \textit{backend} REST en Node.js, una base de datos relacional PostgreSQL, una capa de almacenamiento IPFS materializada mediante nodo Kubo autoalojado para la persistencia descentralizada y un \textit{smart contract} en Solidity desplegado sobre la red Ethereum. Esta arquitectura multi-capa justifica tanto la elección del Proceso Unificado como la necesidad de una estimación de esfuerzo rigurosa y justificada.

Para mantener coherencia con el Anexo I, la estimación se realiza sobre un \textbf{catálogo consolidado de 42 casos de uso principales}. La reducción respecto al inventario funcional inicial responde a un criterio de agrupación: varias operaciones auxiliares o de soporte se documentan como subflujos dentro de UC más amplios y, por tanto, no se ponderan de forma independiente en el cálculo UCP para evitar doble contabilización del esfuerzo.

El detalle del mapeo entre UC integrados y UC principales retenidos se recoge en el Anexo I, de forma que la estimación, la especificación y los diagramas de paquetes comparten el mismo criterio de consolidación.
...
El sistema DocumentChain cuenta con \textbf{5 actores} y un \textbf{catálogo consolidado de 42 casos de uso principales}. Para el cálculo UCP de este anexo se ponderan esos mismos 42 UC, mientras que las operaciones complementarias quedan absorbidas como variantes de los flujos principales. Para facilitar la lectura, los diagramas de casos de uso se presentan agrupados por áreas funcionales. La Figura~\ref{fig:uc_acceso} muestra el paquete de Gestión de Acceso.
...
\hline
UC-0003 & Validar Segundo Factor en el Inicio de Sesión & Medio (4) & 10 \\
\hline
UC-0004 & Cerrar Sesión & Simple (2) & 5 \\
\hline
UC-0005 & Conectar Wallet & Medio (5) & 10 \\
\hline
UC-0006 & Eliminar Wallet & Simple (2) & 5 \\
\hline
UC-0007 & Establecer Wallet Principal & Medio (4) & 10 \\
\hline
UC-0008 & Renombrar/Etiquetar Wallet & Simple (3) & 5 \\
\hline
UC-0009 & Gestionar Perfil & Medio (5) & 10 \\
\hline
UC-0010 & Desactivar Propia Cuenta & Medio (4) & 10 \\
\hline
UC-0011 & Reactivar Propia Cuenta & Medio (5) & 10 \\
\hline
UC-0012 & Cambiar Contraseña & Medio (5) & 10 \\
\hline
UC-0013 & Recuperar Contraseña & Medio (7) & 10 \\
\hline
UC-0014 & Verificar Email & Simple (2) & 5 \\
\hline
UC-0015 & Reenviar Email de Verificación & Simple (2) & 5 \\
\hline
\multicolumn{3}{|r|}{\textbf{Subtotal Gestión de Acceso y Cuenta:}} & \textbf{130} \\
\hline
...
\hline
\endhead
UC-0016 & Subir Documento & Complejo (12) & 15 \\
\hline
UC-0017 & Listar Documentos & Medio (5) & 10 \\
\hline
UC-0018 & Ver Detalle de Documento & Medio (4) & 10 \\
\hline
UC-0019 & Descargar Documento & Complejo (9) & 15 \\
\hline
UC-0020 & Archivar Documento & Medio (5) & 10 \\
\hline
UC-0021 & Desarchivar Documento & Medio (4) & 10 \\
\hline
UC-0022 & Eliminar Documento & Medio (5) & 10 \\
\hline
UC-0023 & Transferir Documento & Medio (7) & 10 \\
\hline
UC-0024 & Buscar Documentos & Complejo (8) & 15 \\
\hline
...
\hline
\endhead
UC-0025 & Crear Nueva Versión & Complejo (10) & 15 \\
\hline
UC-0026 & Listar Versiones & Simple (2) & 5 \\
\hline
UC-0027 & Establecer Versión Operativa & Simple (2) & 5 \\
\hline
UC-0028 & Restaurar Versión Anterior & Medio (7) & 10 \\
\hline
UC-0029 & Descargar Versión Específica & Medio (5) & 10 \\
\hline
...
\hline
\endhead
UC-0030 & Firmar Documento & Complejo (11) & 15 \\
\hline
UC-0031 & Ver Firmas de un Documento & Simple (2) & 5 \\
\hline
UC-0032 & Verificar Firma en Blockchain & Medio (6) & 10 \\
\hline
...
\hline
\endhead
UC-0033 & Compartir Documento & Complejo (10) & 15 \\
\hline
UC-0034 & Revocar Acceso a Documento & Medio (5) & 10 \\
\hline
UC-0035 & Ver Documentos Compartidos Conmigo & Medio (4) & 10 \\
\hline
...
\hline
\endhead
UC-0036 & Ver Timeline de Documento & Medio (5) & 10 \\
\hline
UC-0037 & Ver Estadísticas Personales & Medio (5) & 10 \\
\hline
UC-0038 & Ver Estadísticas Globales del Sistema & Medio (5) & 10 \\
\hline
UC-0039 & Verificar Autenticidad de Documento & Medio (6) & 10 \\
\hline
UC-0040 & Auditoría Blockchain & Medio (6) & 10 \\
\hline
...
\hline
\endhead
UC-0041 & Listar Usuarios & Complejo (10) & 15 \\
\hline
UC-0042 & Gestionar Roles de Usuario & Medio (5) & 10 \\
\hline
...
El resumen de la clasificación de los 42 casos de uso se presenta en la Tabla~\ref{tab:uucw-resumen}.
\begin{table}[H]
\centering
...
\hline
Medio (4--7 Tx) & 26 & 10 & 260 \\
\hline
Complejo (8+ Tx) & 8 & 15 & 120 \\
\hline
\textbf{Total ponderado (UCP)} & \textbf{42} & --- & \textbf{420} \\
\hline
\end{tabular}
    \caption{Resumen de Pesos de Casos de Uso (UUCW)}\label{tab:uucw-resumen}
\end{table}

La Figura~\ref{fig:ezestimate-uc} muestra la pantalla de EZEstimate con la clasificación de los 42 casos de uso por complejidad.
\begin{figure}[H]
    \centering
...
\hline
12 & Especificación consolidada de casos de uso (42 UC principales) & 11 & Desarrollo del catálogo consolidado de 42 casos de uso principales y agrupación de variantes, subflujos y operaciones de apoyo. \\
\hline
...
\hline
25 & Implementación del sistema de autenticación & 24 & Desarrollo del inicio y cierre de sesión con JWT, verificación de segundo factor y soporte base para la vinculación de wallets compatibles. \\
\hline
...
\hline
12 & Especificación consolidada de casos de uso (42 UC) & Elab. I1 & 17/12/2025 & 3 & 19/12/2025 & 11 \\
\hline
...
\hline
61 & Despliegue del smart contract en Sepolia & Trans. I1 & 10/05/2026 & 3 & 12/05/2026 & 58 \\
\hline
...
\begin{ganttchart}[hgrid, time slot format=isodate, x unit=13.5mm]{2025-12-12}{2025-12-22}
  ...
  \ganttbar[bar label font=\scriptsize]{12.\ Catálogo UC (42 UC principales)}{2025-12-17}{2025-12-19} \\
...
\begin{ganttchart}[hgrid, time slot format=isodate, x unit=13.5mm]{2026-05-07}{2026-05-17}
  ...
  \ganttbar[bar label font=\scriptsize]{61.\ Despliegue SC en Sepolia}{2026-05-10}{2026-05-12} \\
...
Se configuró y desplegó el sistema completo en un VPS con Docker Compose, incluyendo el backend, la base de datos PostgreSQL, la integración con el nodo IPFS autoalojado y el smart contract en la red de pruebas Ethereum Sepolia. Se realizaron pruebas funcionales completas en el entorno de producción. \\
\hline
...
\begin{description}
    \item[UCP] Use Case Points, método de estimación de esfuerzo basado en puntos de caso de uso.
    \item[UUCP] Unadjusted Use Case Points, puntos de caso de uso sin ajustar.
    \item[UAW] Unadjusted Actor Weight, peso de actores sin ajustar.
    \item[UUCW] Unadjusted Use Case Weight, peso de casos de uso sin ajustar.
    \item[TCF] Technical Complexity Factor, factor de complejidad técnica.
    \item[ECF] Environmental Complexity Factor, factor de complejidad del entorno.
    \item[EZEstimate] Herramienta de estimación basada en UCP desarrollada para proyectos académicos.
    \item[Proceso Unificado] Metodología de desarrollo software iterativa e incremental (Inicio, Elaboración, Construcción, Transición).
    \item[Transacción] Interacción completa entre actor y sistema para completar un caso de uso.
    \item[Hito] Punto de control del proyecto que marca el final de una iteración o fase.
\end{description}
