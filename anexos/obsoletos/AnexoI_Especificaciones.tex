...
\begin{table}[H]
    ...
    \hline
    UC-0041, UC-0042 & Organización documental mediante carpetas y etiquetas & UC-0017 Listar Documentos y UC-0018 Ver Detalle de Documento \\
    \hline
...
\textbf{NOTA PARA COMPILACIÓN}: Coloque aquí las imágenes generadas desde PlantUML. Ejemplo: el diagrama general de casos de uso se muestra en la Figura~\ref{fig:usecase-general}.
...
La arquitectura del sistema se ilustra en la Figura~\ref{fig:arquitectura}.
