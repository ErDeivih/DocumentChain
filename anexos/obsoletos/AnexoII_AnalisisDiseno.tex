...
En consecuencia, funcionalidades presentes en la entrega como la organización mediante carpetas y etiquetas, la consulta de notificaciones, la configuración de preferencias, la gestión avanzada de wallets o determinadas operaciones administrativas se describen desde la perspectiva del flujo principal al que sirven. El criterio no elimina comportamiento del sistema, sino que reorganiza su documentación para que cada caso de uso represente una capacidad completa y defendible.
...
\subsubsection{Secuencia: Validar Segundo Factor en el Inicio de Sesión}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-2fa.png}
    \caption{Diagrama de secuencia UC-0003: Validar Segundo Factor en el Inicio de Sesión}
    \label{fig:seq-2fa}
\end{figure}
...
Los siguientes diagramas de secuencia documentan funcionalidades que, siguiendo el criterio de consolidación del Anexo~I, se integran como subflujos o extensiones dentro de los 42 casos de uso principales. Cada figura indica el UC principal al que pertenece.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-regen-backup-2fa.png}
    \caption{Subflujo: Regenerar códigos de respaldo 2FA (UC-0003 / UC-0009)}
    \label{fig:seq-regen-backup-2fa}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-edit-metadata.png}
    \caption{Subflujo: Editar metadatos de documento (UC-0018)}
    \label{fig:seq-edit-metadata}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-modify-permissions.png}
    \caption{Subflujo: Modificar permisos de acceso (UC-0033 / UC-0034)}
    \label{fig:seq-modify-permissions}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-create-folder.png}
    \caption{Subflujo: Crear carpeta (UC-0017 / UC-0018)}
    \label{fig:seq-create-folder}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-tag-document.png}
    \caption{Subflujo: Etiquetar documento (UC-0018)}
    \label{fig:seq-tag-document}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-notifications.png}
    \caption{Subflujo: Consultar notificaciones (UC-0009 / UC-0017 / UC-0038)}
    \label{fig:seq-notifications}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-preferences.png}
    \caption{Subflujo: Configurar preferencias de notificación (UC-0009 / UC-0017 / UC-0038)}
    \label{fig:seq-preferences}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-pause-system.png}
    \caption{Subflujo: Pausar sistema de emergencia (UC-0038 / UC-0041 / UC-0042)}
    \label{fig:seq-pause-system}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-resume-system.png}
    \caption{Subflujo: Reanudar sistema (UC-0038 / UC-0041 / UC-0042)}
    \label{fig:seq-resume-system}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-suspend-user.png}
    \caption{Subflujo: Suspender usuario (UC-0041 / UC-0042)}
    \label{fig:seq-suspend-user}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-delete-user-admin.png}
    \caption{Subflujo: Eliminar usuario (admin) (UC-0041 / UC-0042)}
    \label{fig:seq-delete-user-admin}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{diagramas/seq-create-admin.png}
    \caption{Subflujo: Crear cuenta administradora (UC-0041 / UC-0042)}
...
Para el despliegue t\'ecnico completo con Docker Compose, configuraci\'on de redes, vol\'umenes y flujo de actualizaci\'on, v\'ease el Anexo~VI, Secci\'on~``Despliegue t\'ecnico con Docker''.
