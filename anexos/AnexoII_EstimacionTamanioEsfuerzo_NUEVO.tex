...
La estimación se hace sobre un \textbf{catálogo consolidado de 39 casos de uso principales}, en coherencia con el Anexo I. Se redujo el número respecto al inventario funcional inicial porque varias operaciones auxiliares se agruparon como subflujos dentro de casos de uso más grandes. Así se evita contar dos veces el mismo esfuerzo en el cálculo UCP.
...
El sistema DocumentChain cuenta con \textbf{5 actores} y un \textbf{catálogo consolidado de 39 casos de uso principales}. Para el cálculo UCP de este anexo se ponderan esos mismos 39 UC, mientras que las operaciones complementarias quedan absorbidas como variantes de los flujos principales. Para facilitar la lectura, los diagramas de casos de uso se presentan agrupados por áreas funcionales. La Figura~\ref{fig:uc_acceso} muestra el paquete de Gestión de Acceso.
...
\hline
12 & Especificación consolidada de casos de uso (39 UC principales) & 11 & Desarrollo del catálogo consolidado de 39 casos de uso principales y agrupación de variantes, subflujos y operaciones de apoyo. \\
\hline
