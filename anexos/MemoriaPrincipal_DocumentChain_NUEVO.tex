...
\begin{itemize}
    \item \textbf{Migracion a redes blockchain publicas}: desplegar el contrato DocumentRegistry en una red de pruebas publica (una red de pruebas publica) y, tras auditoria de seguridad profesional, migrar a una red principal o Layer 2 (Polygon, Arbitrum) con un sistema de meta-transacciones para eliminar la barrera del gas para el usuario final.
