...
interface ActiveWalletContextType {
  /** Wallet actualmente activa para la visualización de documentos compartidos. */
  activeWallet: SavedWallet | null;
  /** Establece una wallet como activa. */
  setActiveWallet: (wallet: SavedWallet) => void;
  /** Restablece la wallet activa a la wallet predeterminada (principal o primera). */
  resetToPrimary: () => void;
}
