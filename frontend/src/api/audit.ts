...
/**
 * Estado de salud del servicio de auditoría.
 */
...
export const auditApi = {
  ...
  /**
   * Obtiene las estadísticas públicas del sistema.
   * @returns Estadísticas públicas.
   */
  ...
  /**
   * Verifica el estado de salud del servicio de auditoría.
