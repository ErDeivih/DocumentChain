...
/**
 * Panel de confirmacion mostrado antes de transferir la propiedad de un documento.
 * Displays a warning, the recipient's avatar, and (for private documents)
 * a password input required for re-encryption.
 */
export const TransferConfirmationPanel: React.FC<TransferConfirmationPanelProps> = ({
  ...
  <div className="space-y-4">
    ...
    <div className="flex items-center gap-3 rounded-lg border border-border bg-secondary/35 p-3">
      <UserAvatar name={selectedUser.fullName || selectedUser.username} />
      <div>
