...
import { shareService } from '../../services/blockchain';
    ...
    return (
      <Card>
        <div className="p-6 text-center text-muted-foreground">
          A+¦n no hay compartidos. Haga clic en "Compartir" para compartir este documento con otros.
        </div>
      </Card>
    );
  }
  ...
  return (
    <div className="space-y-4">
          ...
          <Card key={share.id}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <UserAvatar name={share.user?.fullName || share.user?.username} />
                <div>
      ...
      <WalletSelectorModal
        ...
        title="Firmar revocaci+¦n de acceso"
        description="Seleccione la wallet propietaria para firmar la revocaci+¦n del acceso en blockchain."
      />
    </div>
  );
};
