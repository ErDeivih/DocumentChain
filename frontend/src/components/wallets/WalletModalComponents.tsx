...
/**
 * Banner verde mostrado cuando hay una wallet conectada.
 * Displays the truncated address and optional "Use this wallet" / "Change wallet" actions.
 */
...
/**
 * Fila que representa una wallet guardada previamente.
 * Highlights when connected and provides actions for select, set-primary, copy, and remove.
 */
