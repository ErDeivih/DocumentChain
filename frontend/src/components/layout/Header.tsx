              ...
              <>
                ...
                <div className="hidden md:flex items-center gap-2">
                  <Link to="/app/notifications">
                    <Button variant="ghost" size="sm" aria-label="Notificaciones" data-testid="header-notifications-btn" className="relative">
                      <Bell className="w-4 h-4" />
                      {unreadCount > 0 && (
                        <span data-testid="header-notifications-badge" className="absolute -top-0.5 -right-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-red-500 text-[10px] font-bold text-white">
